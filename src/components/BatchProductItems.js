...
const BatchProductItems = ({ batch, onClose }) => {
  ...
  const getStatusIcon = status => {
    const icons = {
      MANUFACTURED: (
        <CheckCircle
          size={14}
          className="status-icon manufactured"
        />
      ),
      IN_STOCK: (
        <Package
          size={14}
          className="status-icon in-stock"
        />
      ),
      IN_TRANSIT: (
        <Clock
          size={14}
          className="status-icon in-transit"
        />
      ),
      SOLD: (
        <CheckCircle
          size={14}
          className="status-icon sold"
        />
      ),
    }
  ...
  return (
    <div
      ...
      onClick={onClose}>
      <div
        className="modal-content batch-items-modal"
          ...
          <div className="batch-info-summary">
            ...
            <div className="info-item">
              ...
              <span className="info-value">
                {formatDate(batchInfo.manufactureDate)}
              </span>
            </div>
            <div className="info-item">
              <Calendar size={14} />
              ...
              <span className="info-value">
                {formatDate(batchInfo.expiryDate)}
              </span>
            </div>
          </div>
        )}
