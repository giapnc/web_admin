          ...
          <tbody>
            {transactions.map((tx, idx) => (
              <tr key={idx}>
                ...
                <td>
                  <span className={`tx-type type-${idx % 3}`}>{tx.type}</span>
                </td>
                <td>
                  <span
                ...
                <td>
                  {tx.fullHash && tx.fullHash.startsWith("0x") ? (
                    <a
                      href={`https://sepolia.etherscan.io/tx/${tx.fullHash}`}
                      target="_blank"
                    ...
                    <span className="btn-icon disabled">
                      <ExternalLink size={18} />
                    </span>
                  )}
                </td>
